 ...
 * // $ androidjs init --name Myapp --type html-static
 * ```
 */
export class HtmlStaticGenerator implements Generator {
    context: Context
    constructor() {
...
export default HtmlStaticGenerator